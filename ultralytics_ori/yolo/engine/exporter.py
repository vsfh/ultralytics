...
from ultralytics_ori.nn.autobackend import check_class_names
from ultralytics_ori.nn.modules import C2f, Detect, Segment
from ultralytics_ori.nn.tasks import DetectionModel, SegmentationModel
from ultralytics_ori.yolo.cfg import get_cfg
from ultralytics_ori.yolo.data.dataloaders.stream_loaders import LoadImages
from ultralytics_ori.yolo.data.utils import IMAGENET_MEAN, IMAGENET_STD, check_det_dataset
from ultralytics_ori.yolo.utils import (DEFAULT_CFG, LINUX, LOGGER, MACOS, __version__, callbacks, colorstr,
                                    get_default_args, yaml_save)
from ultralytics_ori.yolo.utils.checks import check_imgsz, check_requirements, check_version, check_yaml
from ultralytics_ori.yolo.utils.files import file_size
from ultralytics_ori.yolo.utils.ops import Profile
from ultralytics_ori.yolo.utils.torch_utils import get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def _export_torchscript(self, prefix=colorstr('TorchScript:')):
        ...
        if self.args.optimize:  # https://pytorch.org/tutorials/recipes/mobile_interpreter.html
            ...
            ts.save('/home/gregory/code/ultralytics/runs/detect/model.pt', _extra_files=extra_files)
        return f, None
