...
from ultralytics_ori import yolo  # noqa
from ultralytics_ori.nn.tasks import (ClassificationModel, DetectionModel, SegmentationModel, attempt_load_one_weight,
                                  CustomModel,
                                  guess_model_task, nn)
from ultralytics_ori.yolo.cfg import get_cfg
from ultralytics_ori.yolo.engine.exporter import Exporter
from ultralytics_ori.yolo.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, callbacks, yaml_load
from ultralytics_ori.yolo.utils.checks import check_file, check_imgsz, check_yaml
from ultralytics_ori.yolo.utils.downloads import GITHUB_ASSET_STEMS
from ultralytics_ori.yolo.utils.torch_utils import smart_inference_mode
...
TASK_MAP = {
    ...
    'custom': [
        CustomModel, yolo.v8.custom.CustomTrainer, yolo.v8.custom.CustomValidator,
        yolo.v8.custom.CustomPredictor]
}
...
class YOLO:
    ...
    def predict(self, source=None, stream=False, **kwargs):
        ...
        if not self.predictor:
            ...
            self.predictor = TASK_MAP['detect'][3](overrides=overrides)
    ...
    def track(self, source=None, stream=False, **kwargs):
        from ultralytics_ori.tracker import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        Args:
            **kwargs : Any other args accepted by the validators. To see all args check 'configuration' section in docs
        """
        from ultralytics_ori.yolo.utils.benchmarks import run_benchmarks
    ...
    def load_weights(self, path, exclude=()):
        import torch
        from ultralytics_ori.yolo.utils.torch_utils import intersect_dicts
