...
from ultralytics_ori.yolo.utils import (DATASETS_DIR, LOGGER, NUM_THREADS, TQDM_BAR_FORMAT, is_colab, is_dir_writeable,
                                    is_kaggle)
from ultralytics_ori.yolo.utils.checks import check_requirements
from ultralytics_ori.yolo.utils.ops import clean_str, segments2boxes, xyn2xy, xywh2xyxy, xywhn2xyxy, xyxy2xywhn
from ultralytics_ori.yolo.utils.torch_utils import torch_distributed_zero_first
        ...
        if im.format.lower() in ('jpg', 'jpeg'):
            with open(im_file, 'rb') as f:
                ...
                if f.read() != b'\xff\xd9':  # corrupt JPEG
                    ...
                    msg = f'{prefix}WARNING ⚠️ {im_file}: corrupt JPEG restored and saved bbb'
